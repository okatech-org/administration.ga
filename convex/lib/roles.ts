...
export const MINISTRY_FOREIGN_AFFAIRS_POSITIONS: PositionTemplate[] = [
  ...
  { code: "intelligence_officer", title: { fr: "Agent de renseignement", en: "Intelligence Officer" }, description: { fr: "Collecte, analyse et exploitation du renseignement diplomatique — rattaché au cabinet ministériel", en: "Collection, analysis and exploitation of diplomatic intelligence — attached to the minister's cabinet" }, level: 4, perm: 22, grade: "agent", ministryCode: "cabinet", taskPresets: ["intelligence_services", "ministry_direction"], isRequired: false },
