...
export const ErrorCode = {
  ...
  APPOINTMENT_PAST_CANCELLATION_DEADLINE: "APPOINTMENT_PAST_CANCELLATION_DEADLINE",
  ...
  INVALID_ARCHIVE_CATEGORY: "INVALID_ARCHIVE_CATEGORY",
  FOLDER_NOT_FOUND: "FOLDER_NOT_FOUND",
  FOLDER_IS_SYSTEM: "FOLDER_IS_SYSTEM",
  DOCUMENT_IN_TRASH: "DOCUMENT_IN_TRASH",
  FOLDER_IN_TRASH: "FOLDER_IN_TRASH",
