	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			<DialogTrigger asChild>
				<button
					type="button"
					className="fixed bottom-4 left-4 z-9999 flex items-center gap-1.5 rounded-full bg-emerald-500 px-3 py-2 text-xs font-bold text-black shadow-lg transition-all hover:bg-emerald-400 hover:scale-105 active:scale-95"
