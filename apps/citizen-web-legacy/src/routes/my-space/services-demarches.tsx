...
function ServicesDemarchesPage() {
	...
	// Regle metier : n'afficher QUE les services proposes par la representation
	// de l'utilisateur (availableServiceIds) + filtre par eligibilite profil.
	// Ex: gabonais en France → services du Consulat du Gabon en France uniquement.
	// Ex: gabonais ne voit pas visa, etranger ne voit pas inscription consulaire.
	...
	// ── Stats ──
	// totalServices = nombre de services disponibles pour cet utilisateur (pas le catalogue global)
	const stats = useMemo(() => {
