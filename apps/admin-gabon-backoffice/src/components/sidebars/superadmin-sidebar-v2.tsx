	...
	const sections: NavSection[] = [
		...
		},
		{
			...
			items: [
				...
				{
					title: t("superadmin.nav.pnpeUtilisateurs", "Utilisateurs PNPE"),
					url: "/pnpe/utilisateurs",
					icon: Users,
					moduleCode: "team",
				},
				{
					title: t("superadmin.nav.pnpeContrats", "Contrats de suivi"),
					url: "/pnpe/contrats",
					icon: FileSignature,
					moduleCode: "statistics",
				},
				{
					title: t("superadmin.nav.pnpeProgrammes", "Auto-Emploi BMC"),
					url: "/pnpe/programmes",
					icon: Lightbulb,
					moduleCode: "statistics",
				},
				{
					title: t("superadmin.nav.pnpeReporting", "Reporting ministère"),
					url: "/pnpe/reporting",
					icon: FileBarChart,
					moduleCode: "statistics",
				},
				{
					title: t("superadmin.nav.pnpeAudit", "Audit PNPE"),
					url: "/pnpe/audit",
					icon: History,
					moduleCode: "statistics",
				},
				{
					title: t("superadmin.nav.pnpeParametres", "Paramètres PNPE"),
					url: "/pnpe/parametres",
					icon: Settings,
					moduleCode: "settings",
				},
