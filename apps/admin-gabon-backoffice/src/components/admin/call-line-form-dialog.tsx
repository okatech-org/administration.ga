...
// Lignes enrichies retournées par listForAdmin
type EnrichedCallLine = Doc<"callLines"> & {
  agents: { membershipId: Id<"memberships">; userId: Id<"users">; name: string; avatarUrl?: string }[];
};
      ...
      <DialogContent className="sm:max-w-md">
        ...
        >
          <FieldGroup>
            ...
            {/* Active — uniquement en mode édition */}
            {mode === "edit" && (
