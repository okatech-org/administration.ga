...
import { Briefcase, Loader2, MapPin, User, Users } from "lucide-react"
...
export function DossierTab() {
  ...
  return (
    <FormProvider {...form}>
      ...
      >
        {/* Masonry layout — CSS columns for natural vertical flow */}
        <div className="settings-forms columns-1 gap-3 lg:columns-2 [&>*]:mb-3 [&>*]:break-inside-avoid">
          {/* ─── Identite ─── */}
          <FlatCard>
            <SectionHeader
            ...
            />
            <div className="settings-compact-form p-3">
              <IdentityStep
...
function SectionHeader({
  ...
  return (
    <div className="flex items-center gap-2 rounded-t-xl bg-[#EBE6DC]/50 px-3 py-2 dark:bg-[#383633]/30">
