	...
	return (
		<>
			...
			<motion.button
				...
				className="fixed right-0 z-50 flex items-center gap-1.5 rounded-l-xl bg-[#0072B9] pl-3 pr-2.5 py-2 shadow-xl opacity-[0.47] lg:hidden"
				style={{ top: "calc(env(safe-area-inset-top, 0px) + 155px)" }}
			>
