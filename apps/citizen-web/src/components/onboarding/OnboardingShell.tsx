...
const STEP_TITLES: Record<OnboardingStepKey, { title: string; description?: string }> = {
	identity: {
		title: "Identité",
		description:
	...
	return (
		<div className="onboarding-root">
			...
			<div className="flex min-h-svh flex-col md:hidden">
				...
				<main className="flex-1 px-4 py-5">{stepBody}</main>
				{!selfNav && (
					...
					<div className="mx-auto flex max-w-[1280px] items-center justify-between px-8 py-3">
						<div className="flex items-center gap-2">
							...
							<div className="flex flex-col leading-tight">
								<strong className="text-sm">Consulat.ga</strong>
						...
						<div className="flex items-center gap-3">
							{savedAtLabel && (
								<span className="inline-flex items-center gap-1.5 rounded-full bg-gabon-green-tint px-3 py-1 text-xs font-medium text-gabon-green">
									<Check className="size-3" strokeWidth={3} />
									Brouillon · {savedAtLabel}
								</span>
							)}
				...
				<div className="mx-auto grid max-w-[1280px] grid-cols-[260px_1fr_320px] gap-8 px-8 py-8">
					...
					<div className="flex min-w-0 flex-col gap-6">
						<Card className="relative overflow-hidden p-0">
							...
							<CardContent className="p-8">{stepBody}</CardContent>
						</Card>
						{!selfNav && (
