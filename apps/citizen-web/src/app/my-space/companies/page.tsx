							...
							<div className="p-3 lg:p-4 flex flex-col items-center justify-center py-12 text-center">
								...
								<p className="text-muted-foreground text-sm max-w-md mb-4">
									{t(
										...
										"Vous n'etes membre d'aucune entreprise. Creez votre premiere entreprise pour commencer.",
									)}
								</p>
			...
			<div className="p-3 lg:p-4 space-y-3">
				...
				<div className="flex gap-2 pt-2">
					<Button variant="outline" size="sm" className="flex-1" asChild>
						<Link href={`/my-space/companies/${company._id}`}>
							{t("common.view")}
			...
			<div className="space-y-4 mt-4">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
					<div className="space-y-2">
						...
						<Select
							...
							onValueChange={(v) =>
								setFormData({ ...formData, companyType: v as CompanyType })
							}
						>
							<SelectTrigger>
					...
					<div className="space-y-2">
						...
						<Select
							...
							onValueChange={(v) =>
								setFormData({ ...formData, activitySector: v as ActivitySector })
							}
						>
							<SelectTrigger>
								<SelectValue placeholder={t("common.select")} />
				...
				<div className="space-y-2">
					...
					<Textarea
						...
						placeholder="Decrivez l'activite de votre entreprise..."
						rows={3}
					/>
				</div>
				<div className="space-y-2">
