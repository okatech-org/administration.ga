...
des nouveaux tokens via `apps/citizen-web/src/app/globals.css`.
...
- `apps/citizen-web/src/app/(public)/page.tsx` (home) — hero avec photo
  background OK, mais sections `Who are you?`, `Featured services`, etc.
  à vérifier
- `apps/citizen-web/src/app/(public)/tarifs/page.tsx`
- `apps/citizen-web/src/app/(public)/faq/page.tsx`
- `apps/citizen-web/src/app/(public)/news/page.tsx`
- `apps/citizen-web/src/app/(public)/ressources/page.tsx`
...
Le layout my-space (`apps/citizen-web/src/app/my-space/layout.tsx`) a sa
...
```sh
grep -rn "bg-primary\b" apps/citizen-web/src --include="*.tsx" | wc -l
```
...
dans `apps/citizen-web/src/components/onboarding/onboarding.css`) sur les
