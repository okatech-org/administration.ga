 ...
 * transitent par le meme domaine que le frontend (consulat.ga).
 */
export default defineEventHandler(async (event) => {
	// CONVEX_SITE_URL est injecte par `convex deploy --cmd` lors de la build
	// ou configure dans les env vars Cloud Run
