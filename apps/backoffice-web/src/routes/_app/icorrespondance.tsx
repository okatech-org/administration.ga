...
function VaultFileCard({
  ...
  return (
    <div
      className={cn(
        "group flex h-full cursor-pointer flex-col overflow-hidden rounded-xl border border-border/50 bg-card transition-all duration-300",
        isSelected &&
    ...
    >
      <div className="relative flex aspect-[1/1.414] flex-col overflow-hidden bg-white/[0.03]">
        ...
        <div className="flex flex-1 items-center justify-center px-3 py-2">
          <div className="relative flex h-[72px] w-14 flex-col items-center justify-center rounded-[2px] border border-neutral-200 bg-[#FDFCFA] dark:bg-[#21201E]/77">
