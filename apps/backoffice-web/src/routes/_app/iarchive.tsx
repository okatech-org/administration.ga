...
// ═══════════════════════════════════════════════════════════════
// MOCK DATA — Contexte diplomatique (Administration)
// ═══════════════════════════════════════════════════════════════
...
const MOCK_ARCHIVES: ArchiveItem[] = [
	...
	{ id: "arch-9", title: "Audit interne 2025", archivedAt: "15/02/2026", archivedAtTs: 1771123200000, expiresAt: "15/02/2031", size: "3.2 Mo", hash: "9a8b7c6d…5e4f", status: "active", certId: "CERT-2026-003", archivedBy: "Chef Audit DIALLO", archivedByInitials: "CA", folderId: "fiscal" },
	{ id: "arch-10", title: "Protocole de sécurité ambassade", archivedAt: "10/01/2026", archivedAtTs: 1768828800000, expiresAt: "Illimité", size: "2.1 Mo", hash: "7f6e5d4c…3b2a", status: "active", certId: "CERT-2026-004", archivedBy: "Directeur Sécurité AKOMO", archivedByInitials: "DS", folderId: "coffre" },
];
		...
		<motion.div initial="hidden" animate="visible" variants={stagger} className="space-y-5 max-w-[1400px] mx-auto p-4">
			...
			<motion.div variants={fadeUp} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
				<div className="flex items-center gap-3">
					...
					<div>
						<h1 className="text-2xl font-bold tracking-tight">iArchive — Administration</h1>
						<p className="text-sm text-muted-foreground">Gestion centralisée des archives diplomatiques</p>
					</div>
				</div>
