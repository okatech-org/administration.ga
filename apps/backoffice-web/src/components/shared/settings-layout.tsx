...
export function SettingsLayout({
  ...
  return (
    <div className="flex min-h-full w-full flex-1 flex-col gap-4 overflow-auto p-3 md:p-4">
      ...
      <div className="flex flex-1 flex-col overflow-hidden rounded-2xl bg-secondary md:flex-row">
        {/* Sidebar → horizontal scroll on mobile */}
        <aside className="flex w-full shrink-0 flex-row gap-1 overflow-x-auto border-b border-border/50 px-2 py-2 md:w-56 md:flex-col md:border-r md:border-b-0 md:p-4 lg:w-64">
          {tabs.map((tab) => {
