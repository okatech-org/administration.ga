...
/**
 * Page dédiée Corps Diplomatique — extraite de l'ancien onglet
 * `/users?view=diplomatic`. Affiche les membres du corps administratif
 * avec leur profil diplomatique (hiérarchie continent → pays → org →
 * grade → statut).
 */
	...
	return (
		<div className="flex flex-1 flex-col gap-4 px-7 pt-6 pb-[60px]">
			<PageHeader
				...
				subtitle="Membres du corps administratif et leur profil diplomatique"
			/>
