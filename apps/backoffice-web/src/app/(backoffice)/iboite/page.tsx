...
// LiveKit non disponible dans backoffice — appels masqués
...
// Appels non disponibles dans backoffice — stub
const useMeeting = (_id?: string) => ({
	isConnecting: false,
	isConnected: false,
	isMicMuted: false,
	isCamOff: true,
...
const LiveKitRoom = ({ children }: { children: React.ReactNode; [k: string]: any }) => <>{children}</>;
const CustomCallUI = (_props: any) => null;
import {
