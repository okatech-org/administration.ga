...
/**
 * Signature officielle — page de configuration pour les agents habilités
 * (permission `documents.sign`).
 *
 * Permet de téléverser une image PNG de signature et un titre (ex. "Le
 * Consul Général"). L'image sera apposée automatiquement sur les documents
 * signés via l'action signDocument.
 */
...
export default function SignaturePage() {
	...
	// Keep the input controlled once the signature loads.
	if (!isLoading && signature && title === "" && signature.title) {
	...
	return (
		<div className="flex flex-col gap-6 p-4 md:p-6">
			<header className="flex items-center gap-3">
				...
				<div>
					<h1 className="text-xl font-bold">Signature officielle</h1>
			...
			<FlatCard className="p-4 md:p-6">
				<div className="flex flex-col gap-6">
					<div className="flex flex-col gap-2">
						<Label>Aperçu</Label>
						<div className="flex min-h-[120px] items-center justify-center rounded-xl border border-dashed bg-background p-4">
							{isLoading ? (
