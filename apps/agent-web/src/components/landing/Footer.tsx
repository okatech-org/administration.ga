				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-12">
					...
					<div className="space-y-4">
						<div className="flex items-center gap-3">
							...
							<span className="font-display font-bold text-lg tracking-tight">
								Diplomate<span className="text-emerald-400">.ga</span>
							</span>
						</div>
					...
					<div>
						...
						<ul className="space-y-3 text-sm text-slate-400">
							...
							<li>
								<span className="block text-slate-300 font-medium">Adresse</span>
			...
			<div className="border-t border-white/5">
				<div className="container mx-auto px-6 lg:px-12 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
					<p className="text-slate-500 text-xs">
						...
						— République Gabonaise. Tous droits réservés.
					</p>
					<p className="text-slate-600 text-xs">
						Conforme aux Conventions de Vienne 1961 &amp; 1963
					</p>
				</div>
			</div>
		</footer>
