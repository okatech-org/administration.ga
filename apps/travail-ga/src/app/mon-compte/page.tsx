...
/**
 * Mon compte — vue d'ensemble (TRAVAIL.GA).
 *
 * Espace candidat avec deux états :
 *  - Non connecté → CTA PNPE.GA + indication du switcher dev en local.
 *  - Connecté (session Better Auth) → carte identité + KPIs placeholder
 *    + raccourcis vers candidatures / offres / PNPE.GA.
 *
 * Le wrapping (SiteHeader/SiteFooter/Sidebar) est géré par
 * `app/mon-compte/layout.tsx` — cette page ne rend QUE le contenu central.
 */
    ...
    <>
      ...
      {isAuthed ? (
        ...
        >
          ...
          <a href={pnpeLink("/dashboard")} style={{ textDecoration: "none" }}>
        ...
        >
          <div>
            ...
            {!isPending && process.env.NODE_ENV !== "production" && (
              <p
                style={{
                  marginTop: 14,
                  fontSize: 12.5,
              ...
              >
                ...
                <strong style={{ color: "var(--brand-emerald)" }}>DEV</strong>{" "}
                en bas à droite pour basculer entre comptes de démo.
              </p>
            )}
          </div>
          <a href={pnpeLink("/auth/sign-in")} style={{ textDecoration: "none" }}>
            <Button size="lg" iconRight={<Icons.ArrowUR size={16} />}>
              Aller sur PNPE.GA
            </Button>
          </a>
      ...
      >
        ...
        >
          ...
          >
            Suivez l&apos;avancement de vos postulations. Pipeline et statuts
            en temps réel.
          </p>
        </Link>
