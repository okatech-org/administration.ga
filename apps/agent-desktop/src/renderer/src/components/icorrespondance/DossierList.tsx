		...
		<div className="space-y-4">
			...
			<div className="border border-border/50 rounded-xl overflow-hidden bg-card">
				...
				<div className="grid grid-cols-12 gap-2 px-4 py-2 border-b border-border/50 bg-muted/30 text-[10px] font-semibold uppercase tracking-wider text-muted-foreground">
					...
					<div className="col-span-2">Etape courante</div>
					<div className="col-span-1">Statut</div>
					<div className="col-span-1">Priorite</div>
					<div className="col-span-1">Depot</div>
					<div className="col-span-2">Delai</div>
				</div>
				...
				{!isLoading && filtered.length === 0 && (
					<div className="flex flex-col items-center justify-center py-16 text-muted-foreground">
						...
						<span className="text-xs">Aucun dossier trouve</span>
			...
			{!isLoading && (
				<div className="text-[10px] text-muted-foreground px-1">
					{filtered.length} dossier{filtered.length !== 1 ? "s" : ""} affiches
