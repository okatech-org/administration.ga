/**
 * CorrespondanceDossier — Folder-style card for a correspondance item.
 * Shows dynamic folder icon with document count, badges, and metadata.
 */
...
const RECIPIENT_STATUS_LABELS: Record<string, { label: string; color: string }> = {
  ...
  recu: { label: "Recu", color: "text-blue-400 bg-blue-500/15" },
  en_attente: { label: "En attente", color: "text-orange-400 bg-orange-500/15" },
  approuve: { label: "Approuve", color: "text-emerald-400 bg-emerald-500/15" },
  repondu: { label: "Repondu", color: "text-violet-400 bg-violet-500/15" },
};
      ...
      >
        ...
        <div className="flex flex-col items-center mt-3 w-full">
          <div className="flex items-center gap-1 flex-wrap justify-center mb-1">
            ...
            <span className={cn("text-[8px] px-1 py-0 h-4 inline-flex items-center font-mono border border-primary/20 bg-primary/5 rounded-full")}>
