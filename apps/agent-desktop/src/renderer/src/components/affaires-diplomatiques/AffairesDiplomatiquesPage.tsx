...
export function AffairesDiplomatiquesPage() {
	...
	return (
		<div className="flex flex-col gap-4 p-4 lg:p-6 h-full overflow-y-auto">
			...
			<div className="flex-1 min-h-0">
				{activeTab === "cibles" && orgId && <CiblesTab orgId={orgId} />}
				{activeTab === "lettres" && orgId && <LettresTab orgId={orgId} />}
				{activeTab === "plans" && orgId && <PlansTab orgId={orgId} />}
				{activeTab === "rapports" && orgId && <RapportsTab orgId={orgId} />}
			</div>
		</div>
	);
}
