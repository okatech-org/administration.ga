...
import {
	Archive, Search, Shield, Clock, Lock, Landmark, Users2, Scale,
	Building2, FileText, Folder, FolderOpen, FolderPlus,
	X,
	MoreHorizontal, Share2, Info, KeyRound, Tag,
	Trash2, CalendarClock, GitBranch, User,
...
function VaultFileCard({ title, iconColor = "text-stone-600", author: _author, authorInitials: _authorInitials, date, statusBadge, version, contextMenu, badges, tags: _tags = [], retentionCategory, retentionColor, onClick, isSelected = false, layoutId }: {
...
function FolderContextMenu({ itemId, itemName: _itemName, itemType, onShare, onSavePolicy, onInfo, onManageAccess, onCreateSubfolder, onDelete, isSystem }: {
