	...
	const navSections: NavSection[] = [
		...
		},
		{
			...
			items: [
				...
				{ title: "Dossiers", url: "/agence/dossiers", icon: FolderKanban, requires: "intelligence.cases.view", moduleCode: "intelligence" },
				{ title: "Cohortes (TAL)", url: "/agence/cohortes", icon: Briefcase, requires: "intelligence.profiles.search", moduleCode: "intelligence" },
				{ title: "Briefings IA", url: "/agence/briefings", icon: Sparkles, requires: "intelligence.briefing.generate", moduleCode: "intelligence" },
				{ title: "Graphe", url: "/agence/graphe", icon: Network, requires: "intelligence.links.view", moduleCode: "intelligence" },
				{ title: "Alertes", url: "/agence/alertes", icon: BellRing, requires: "intelligence.watchlists.view", moduleCode: "intelligence" },
			],
		},
		...(extraSections ?? []),
		{
