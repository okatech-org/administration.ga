...
/**
 * Affaires Consulaires — Profils Citoyens
 *
...
export default function ConsularProfilesPage() {
						...
						<AnimatePresence mode="popLayout">
							{paginated.map((profile: any, i: number) => (
								<ProfileCard
									...
									onOpen={() =>
										router.push(`/affaires-consulaires/profiles/${profile._id}`)
									}
								/>
							))}
						</AnimatePresence>
